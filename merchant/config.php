...
define('HTTP_SERVER', HTTP_CATALOG.'merchant/');

// HTTPS
define('HTTPS_CATALOG', 'https://'.$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT'].'/');
define('HTTPS_SERVER', HTTPS_CATALOG.'merchant/');
...
define('DIR_TEMPLATE', 'E:\xampp-1.7.7\htdocs\lexus_mobile/admin/merchant/view/template/');
