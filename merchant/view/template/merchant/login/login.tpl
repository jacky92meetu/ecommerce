                    ...
                    <div class="widget-main">
                        ...
                        <div class="flat-form">
                            ...
                            <div class="row menu-list">
                                <ul class="tabs">
                                    <li>
                                        <a href="#register" class="active" data-rel="tooltip" title="" data-original-title="Register">
                                            <i class="ace-icon fa fa-users"></i>
                                            <span class="">Register</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#login" data-rel="tooltip" title="" data-original-title="Login"><i class="ace-icon fa fa-key"></i>
                                            <span class="">Login</span></a>
                                    </li>
                                    <li>
                                        <a href="#reset" data-rel="tooltip" title="" data-original-title="Reset Password"><i class="ace-icon fa fa-lock"></i>
                                            <span class="">Reset Password</span></a>
                                    </li>
                                </ul>
                            </div>
