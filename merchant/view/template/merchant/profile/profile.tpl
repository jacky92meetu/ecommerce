                ...
                <div class="widget-header">
                    ...
                    <div class="pull-right">
                        <label class="pull-right inline">
                            <a class="btn btn-bold ubib-green-btn" href="/merchant/profile/editprofile?merchant_id=<? echo $pdata['merchant_id']; ?>">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-3 center">
                                ...
                                <div class="widget-box transparent">
                                    <div class="widget-body">
                                        <div class="widget-main no-padding">
                                            <div class="profile-picture editable" id="image_cover_upload">
                                                <img class="img-responsive" id="image_cover" src="<? echo $store_image_cover; ?>">
                                            </div>
                                            <div class=" text-info text-center smaller-90">
                                                Hints: Click image to change profile cover. Fixed width x Height (980px X 300px)
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
            ...
            var btn = $('#image_upload');
                    ...
                    button: btn,
                            url: '/merchant/profile/ajaximageupload?merchant_id=<? echo $pdata['merchant_id']; ?>',
                            name: 'file',
                            multiple: false,
                            multipart: true,
                            maxUploads: 1,
                            ...
                            $(btn).find('img').attr('src', data.img_url);
                                    if ("<? echo $pdata['merchant_id']; ?>" == "<? echo $this->merchant->getInfo('merchant_id'); ?>"){
...
<script type="text/javascript">
            jQuery(function($){
            var btn = $('#image_cover_upload');
                    var $widget = $(btn).closest('.widget-box');
                    var uploader = new ss.SimpleUpload({
                    button: btn,
                            url: '/merchant/profile/ajaximagecoverupload?merchant_id=<? echo $pdata['merchant_id']; ?>',
                            name: 'file',
                            multiple: false,
                            multipart: true,
                            maxUploads: 1,
