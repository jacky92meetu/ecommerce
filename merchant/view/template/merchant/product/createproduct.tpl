        ...
        <div class="widget-box">										
                ...
                <div class="widget-body">                       
                        <div class="widget-main no-padding">                            
                            <form class="form-horizontal validation-form" role="form" action="/merchant/product/create?merchant_id=<? echo $this->merchant->getId(); ?>" method="POST">
                                                            ...
                                                            <div class="static dropzone-previews">
                                                                ...
                                                                <div class="dz-preview dz-image-preview" style="margin:5px;" image_id="<? echo $key; ?>">
                                                                    <div class="dz-details">
                                                                      ...
                                                                      <img data-dz-thumbnail src="<? echo $this->merchant->image_link($value); ?>" />
                                                                    </div>                                                                    
                                                                    <a class="remove pull-left" href="javascript:dropzone_image_delete('<? echo $key; ?>',true);" alt="Remove"  data-rel="tooltip" title="Remove">
                                                                        <i class="ace-icon fa fa-trash-o icon-on-left bigger-125 line-height-125 red"></i>
                                                                    </a>
                                                                    <a class="set_default pull-right" href="javascript:image_set_default('<? echo $key; ?>');" alt="Set as default"  data-rel="tooltip" title="Set as default">
...
<div class="modal" id="descSample" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel">Description Sample</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-xs-12">
                        <img class='img-responsive' src='/image/data/merchant/product_description_sample.jpg'>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
        ...
        $('form.validation-form').each(function() {
            var $validator = $(this).validate({
                ...
                submitHandler: function(form) {
                    ...
                    //set image_list
                    var $temp = {};
                    $('.dropzone-previews .dz-image-preview[image_id]').each(function() {
                        $temp[$(this).attr('image_id').toString()] = $(this).attr('image_id').toString();
                    });                    
                    $(form).find('input[name="image_list"]').val(JSON.stringify($temp));
    ...
    jQuery(function($){
        ...
        var uploader = new ss.SimpleUpload({
            ...
            onSizeError: function(filename, fileSize) {
                alert('Your uploaded image ('+filename + ') file size exceed ' + max_size + 'Kb.\n\nPlease upload image with the file size less than ' + max_size + 'Kb.');
            },
            ...
            onComplete: function(filename, data) {
                ...
                if (typeof data.status === 'string' && data.status == "success") {
                    $('.dz-preview[file_name="' + filename + '"]')
                            ...
                            .append($('<a class="remove pull-left" href="javascript:dropzone_image_delete(\'' + data.id + '\',true);" alt="Remove" data-rel="tooltip" title="Remove"><i class="ace-icon fa fa-trash-o icon-on-left bigger-125 line-height-125 red"></i></a>'));
