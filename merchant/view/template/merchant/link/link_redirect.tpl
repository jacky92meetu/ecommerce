                    ...
                    <form class="form-horizontal validation-form" role="form" action="/merchant/system/link_manage?link_type=<? echo $pdata['link_type']; ?>" method="POST">                                        
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 control-value">
                                    <div class="clearfix">
                                        <input type="text" name="link_value[link_url]" class="form-control" placeholder="E.g.: http://www.example.com"  value="<? echo $pdata['link_value']['link_url']; ?>"/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
