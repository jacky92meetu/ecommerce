<?    
    if(!isset($pdata)){
        $pdata = array("floor_value"=>array("template_image"=>array(
            ...
            "3"=>array("image_url"=>"/image/floor_template/default/box-190px-390px.jpg"),
            "4"=>array("image_url"=>"/image/floor_template/default/box-190px-390px.jpg"),
        ...
        <div class="col-xs-12 col-sm-6 right">            
            <div class="row">
                <div class="col-xs-8 col-sm-8 image full-400">
                    <div class="row">
                        <div class="col-xs-6 image image2" image_class="image_size_190_390" image_id="3">
                            <? echo $pdata['floor_value']['template_image']['3']['image_price']; ?>
                            <a href="<? echo $pdata['floor_value']['template_image']['3']['image_link']; ?>"><img src="<? echo $pdata['floor_value']['template_image']['3']['image_url']; ?>" /></a>
                        </div>
                        <div class="col-xs-6 image image2" image_class="image_size_190_390" image_id="4">
                            <? echo $pdata['floor_value']['template_image']['4']['image_price']; ?>
                            <a href="<? echo $pdata['floor_value']['template_image']['4']['image_link']; ?>"><img src="<? echo $pdata['floor_value']['template_image']['4']['image_url']; ?>" /></a>
                        </div>
                    </div>
                </div>
