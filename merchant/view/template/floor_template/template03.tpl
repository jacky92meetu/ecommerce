<?
    if(!isset($pdata)){
        $pdata = array("floor_value"=>array("template_image"=>array(
            ...
            "7"=>array("image_url"=>"/image/floor_template/default/box-390px-190px.jpg"),
            ...
            "13"=>array("image_url"=>"/image/floor_template/default/box-190px-190px.jpg")
        )));
    }
    ...
    <div class="row floor-content">
        <div class="hidden-xs col-xs-12 col-sm-6 left">
            ...
            <div class="row hidden-xs hide-800">
                <div class="col-xs-12 image" image_class="image_size_390_190" image_id="7">
                    <? echo $pdata['floor_value']['template_image']['7']['image_price']; ?>
                    <a href="<? echo $pdata['floor_value']['template_image']['7']['image_link']; ?>"><img src="<? echo $pdata['floor_value']['template_image']['7']['image_url']; ?>" /></a>
                </div>
            </div>
        </div>
        <div class="col-xs-12 col-sm-6 right">            
            ...
            <div class="row hidden-xs hide-800">
                <div class="col-xs-4 col-sm-4 image half-400" image_class="image_size_190_190" image_id="9">
                ...
                <div class="col-xs-4 col-sm-4 image half-400" image_class="image_size_190_190" image_id="10">
                ...
                <div class="col-xs-4 col-sm-4 image half-400" image_class="image_size_190_190" image_id="13">
                    <? echo $pdata['floor_value']['template_image']['13']['image_price']; ?>
                    <a href="<? echo $pdata['floor_value']['template_image']['13']['image_link']; ?>"><img src="<? echo $pdata['floor_value']['template_image']['13']['image_url']; ?>" /></a>
                </div>
            </div>
        </div>
    </div>
