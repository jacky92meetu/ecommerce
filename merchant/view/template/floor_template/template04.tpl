<?
    if(!isset($pdata)){
        $pdata = array("floor_value"=>array("template_image"=>array(
            ...
            "8"=>array("image_url"=>"/image/floor_template/default/box-390px-390px.jpg"),
            "9"=>array("image_url"=>"/image/floor_template/default/box-190px-190px.jpg"),
            "10"=>array("image_url"=>"/image/floor_template/default/box-190px-190px.jpg"),
            "11"=>array("image_url"=>"/image/floor_template/default/box-190px-190px.jpg"),
            "12"=>array("image_url"=>"/image/floor_template/default/box-190px-190px.jpg"),
            "14"=>array("image_url"=>"/image/floor_template/default/box-190px-390px.jpg")
        )));
    }
...
<div class="col-xs-12 product-floor-list">
    ...
    <div class="row floor-content">
        <div class="hidden-xs col-xs-12 col-sm-6 left">
            ...
            <div class="row hidden-xs hide-800">
                <div class="col-xs-12 image image2" image_class="image_size_390_390" image_id="8">
                    <? echo $pdata['floor_value']['template_image']['8']['image_price']; ?>
                    <a href="<? echo $pdata['floor_value']['template_image']['8']['image_link']; ?>"><img src="<? echo $pdata['floor_value']['template_image']['8']['image_url']; ?>" /></a>
                </div>
            </div>
        </div>
        <div class="col-xs-12 col-sm-6 right">            
            ...
            <div class="row hidden-xs hide-800">
                <div class="col-xs-8 col-sm-8">
                    <div class="row">
                        <div class="col-xs-6 image" image_class="image_size_190_190" image_id="9">
                            <? echo $pdata['floor_value']['template_image']['9']['image_price']; ?>
                            <a href="<? echo $pdata['floor_value']['template_image']['9']['image_link']; ?>"><img src="<? echo $pdata['floor_value']['template_image']['9']['image_url']; ?>" /></a>
                        </div>
                        <div class="col-xs-6 image" image_class="image_size_190_190" image_id="10">
                            <? echo $pdata['floor_value']['template_image']['10']['image_price']; ?>
                            <a href="<? echo $pdata['floor_value']['template_image']['10']['image_link']; ?>"><img src="<? echo $pdata['floor_value']['template_image']['10']['image_url']; ?>" /></a>
                        </div>
                        <div class="col-xs-6 image" image_class="image_size_190_190" image_id="11">
                            <? echo $pdata['floor_value']['template_image']['11']['image_price']; ?>
                            <a href="<? echo $pdata['floor_value']['template_image']['11']['image_link']; ?>"><img src="<? echo $pdata['floor_value']['template_image']['11']['image_url']; ?>" /></a>
                        </div>
                        <div class="col-xs-6 image" image_class="image_size_190_190" image_id="12">
                            <? echo $pdata['floor_value']['template_image']['12']['image_price']; ?>
                            <a href="<? echo $pdata['floor_value']['template_image']['12']['image_link']; ?>"><img src="<? echo $pdata['floor_value']['template_image']['12']['image_url']; ?>" /></a>
                        </div>
                    </div>                    
                </div>                
                <div class="col-xs-4 col-sm-4 image image2" image_class="image_size_190_390" image_id="14">
                    <? echo $pdata['floor_value']['template_image']['14']['image_price']; ?>
                    <a href="<? echo $pdata['floor_value']['template_image']['14']['image_link']; ?>"><img src="<? echo $pdata['floor_value']['template_image']['14']['image_url']; ?>" /></a>
                </div>
            </div>            
        </div>
    </div>
