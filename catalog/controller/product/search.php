...
class ControllerProductSearch extends Controller { 	
	public function index() { 
		...
		if (isset($this->request->get['search'])) {
			...
			$url .= '&search_all=' . urlencode(html_entity_decode($this->request->get['search_all'], ENT_QUOTES, 'UTF-8'));
		}
		...
		if (isset($this->request->get['search_all']) || isset($this->request->get['search']) || isset($this->request->get['tag'])) {
			$data = array(
				'filter_name'         => $search, 
				'filter_tag'          => $tag, 
